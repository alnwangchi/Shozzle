...
我自己是有裝這幾個 extension
![](https://hackmd.io/_uploads/HyZAYDK16.png)

### 需要先記一下的 vim 模式

看到的 commit 是越下面越新，可能會跟工具介面相反，這邊有點容易搞混

![](https://hackmd.io/_uploads/Hk1n7uK1a.png)
...
![](https://hackmd.io/_uploads/Hk_l8tYkT.png)

![](https://hackmd.io/_uploads/rJLMLFFka.png)
...
![](https://hackmd.io/_uploads/B1ZujFKkp.png)
...
![](https://hackmd.io/_uploads/H1U3ittJa.png)
...
- 先啟用 rebase 編輯器
  ![](https://hackmd.io/_uploads/Sks2hDFkT.png)

- 在想要修改的地方右鍵點選
  ![](https://hackmd.io/_uploads/ByQ46wKy6.png)

- 再選第二個選項就可以進入了
  ![](https://hackmd.io/_uploads/BkjYTDY1p.png)

- 這樣就可以開始做操作了
  ![](https://hackmd.io/_uploads/H1KTRvYyT.png)
