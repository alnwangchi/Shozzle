...
title: a CSS a day keeps the doctor away (1)
date: 2023-04-20
author: Allen Wang
...
## a CSS a day keeps the doctor away 系列前言
...
<img src="https://i.imgur.com/En3Sz11.png" class="md:w-[30vw]" title="source: imgur.com" />
...
當 `<li>` 被 hover 的時候下層的 `<a>` 會顯示，因為用了相同的標識符 `group/item` 此時要再 hover 到 `<a>` 再下層的 `<span>` 跟 `<svg>` 才會有另外的效果，因為有定義另外的 `group/edit`

```html
<div className="group/item ...">
  <div className="...">
    <div className="...">
      <img className="..." src="/images/MyHead.png" alt="" />
    </div>
  ...
  <span href="#" className="group/edit invisible hover:bg-slate-300 group-hover/item:visible ...">
