...
title: 每日 C ss 系列 - Tailwind 核心概念與設定
date: 2023-05-18
author: Allen Wang
image: { src: 'https://i.imgur.com/YuZqxzZ.png', alt: '範例' }
...
```html
<div className="flex items-center justify-center border border-solid border-sky-400 h-[50px] w-[50px]">
  <span>OK</span>
</div>
```
